"""v7.1 TN_RECOVERY — v7 stronger conservative safety auditor adapted for stride-4 (2s).

Identical to v7_TN_RECOVERY except:
  - Sequence duration: 4 seconds -> 2 seconds (stride-4 window)
  - "4-SECOND WINDOW" -> "2-SECOND WINDOW" in step 3
  - "4 full seconds" -> "2 full seconds" in stability note
...
PROMPT_G_OPT_v7_1_TN_RECOVERY = (
    ...
    "STEP 3 -- STABILITY ANALYSIS ACROSS A 2-SECOND WINDOW:\n"
    "Compare early (1-5), middle (6-11), and recent (12-16) frames.\n\n"

    "Carefully evaluate whether:\n"
    "- spacing remains stable across the 2-second window\n"
    ...
    "IMPORTANT:\n"
    "Stable spacing maintained across 2 full seconds of footage is strong evidence "
