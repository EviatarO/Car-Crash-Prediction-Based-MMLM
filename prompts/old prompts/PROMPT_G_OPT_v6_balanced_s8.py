"""Identical to PROMPT_G_OPT_v6_balanced except the 'Sequence duration' line is
updated to reflect the stride-8 sampling (≈ 4 seconds of history instead of ≈ 2 s).

Same final-frame anchor as the stride-4 extraction; the window simply extends
twice as far back.
"""

PROMPT_G_OPT_v6_balanced_s8 = (
