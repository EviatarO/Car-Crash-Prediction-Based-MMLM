...
PROMPT_G_OPT_8f = (
    ...
    "INPUT:\n"
    "- 8 chronologically ordered dashcam frames\n"
    "- Frame 1 = oldest frame\n"
    "- Frame 8 = most recent frame\n"
    ...
    "Analyze how risk evolves between early frames (1-3), middle frames (4-6), "
    "and recent frames (7-8).\n\n"
