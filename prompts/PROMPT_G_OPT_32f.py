...
PROMPT_G_OPT_32f = (
    ...
    "INPUT:\n"
    "- 32 chronologically ordered dashcam frames\n"
    "- Frame 1 = oldest frame\n"
    "- Frame 32 = most recent frame\n"
    ...
    "Analyze how risk evolves between early frames (1-10), middle frames (11-22), "
    "and recent frames (23-32).\n\n"
