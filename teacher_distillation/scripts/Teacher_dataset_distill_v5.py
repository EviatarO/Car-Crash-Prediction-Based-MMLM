"""Teacher Dataset Distill v5 -- Replay-only with PROMPT_J."""
...
from prompts.templates import PROMPT_J
        ...
        rows.append(
            {
                ...
                "lane_positions": rec.get("lane_positions"),
...
def main() -> None:
    ...
    client = OpenAI(
        ...
        default_headers={
            ...
            "X-Title": os.environ.get("OPENROUTER_APP_TITLE", "MMLM_Teacher_Distill_V5"),
        },
    )
    ...
    with open(output_jsonl, "w", encoding="utf-8") as fout:
        for i, clip in enumerate(clips, start=1):
            messages = _build_messages(PROMPT_J, clip["image_b64s"], detail=args.detail)
            raw_response = ""
            usage: Dict = {}
            err = None
            t0 = time.time()
            ...
            record = {
                ...
                "lane_positions": parsed_obj.get("lane_positions") if parsed_obj else None,
    ...
    print("\nConfusion Matrix (v5 / PROMPT_J):", flush=True)
