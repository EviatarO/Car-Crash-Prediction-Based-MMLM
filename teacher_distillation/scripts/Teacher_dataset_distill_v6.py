"""Teacher Dataset Distill v6 -- Replay-only with PROMPT_K (4-stage CoT)."""
...
from prompts.templates import PROMPT_K
        ...
        rows.append(
            {
                ...
                "perceive_summary": rec.get("perceive_summary"),
...
def main() -> None:
    ...
    client = OpenAI(
        ...
        default_headers={
            ...
            "X-Title": os.environ.get("OPENROUTER_APP_TITLE", "MMLM_Teacher_Distill_V6"),
        },
    )
    ...
    with open(output_jsonl, "w", encoding="utf-8") as fout:
        for i, clip in enumerate(clips, start=1):
            messages = _build_messages(PROMPT_K, clip["image_b64s"], detail=args.detail)
            raw_response = ""
            usage: Dict = {}
            err = None
            t0 = time.time()
            ...
            record = {
                ...
                "perceive_summary": parsed_obj.get("perceive_summary") if parsed_obj else None,
    ...
    print("\nConfusion Matrix (v6 / PROMPT_K):", flush=True)
